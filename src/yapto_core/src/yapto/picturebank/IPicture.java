...
public interface IPicture extends Comparable<IPicture>
{
	...
	/**
	 * Get the {@link IPictureBank} from which this {@link IPicture} is coming.
	 * 
	 * @return the {@link IPictureBank} from which this {@link IPicture} is
	 *         coming.
	 */
	IPictureBank<? extends IPicture> getPictureBank();
